    ...
    return (
        <div className="max-w-7xl mx-auto my-16">
            ...
            <div className="mt-12 w-1/2 md:w-1/3 mx-auto">
                <Link to='/all-stories'>
                    <button className="text-black btn-outline btn justify-center w-full mx-auto font-semibold flex items-center gap-4 text-sm md:text-xl ">Read more stories <FaCircleArrowRight /></button>
                </Link>
            </div>
