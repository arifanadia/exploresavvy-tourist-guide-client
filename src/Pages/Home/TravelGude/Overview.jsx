    ...
    return (
        <div className=" mt-12 ">
            ...
            <div className="mt-12 w-1/3 mx-auto">
                <button className="text-black btn-outline btn justify-center w-full mx-auto font-semibold flex items-center gap-4  text-xl ">About Us <FaCircleArrowRight /></button>
            </div>
