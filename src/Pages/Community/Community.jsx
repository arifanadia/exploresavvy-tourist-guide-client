    ...
    return (
        <section className=" min-h-screen">
            ...
            <section className="text-center py-12 px-4 md:px-8">
                ...
                <p className="text-lg text-gray-100 leading-relaxed" data-aos="fade-up">
            ...
            <section className="px-4 md:px-8 py-12">
                <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                    <div className="bg-[#000435] rounded-lg shadow-lg p-6 flex flex-col items-center" data-aos="fade-up">
            ...
            <section className="px-4 md:px-8 py-12 bg-gray-200">
                <h2 className="text-3xl text-[#000435] font-semibold text-center mb-8" data-aos="fade-down">
                ...
                <div className="flex flex-wrap gap-6 justify-center">
                    {blogs.length > 0 ? (
                        blogs.slice(0, 4).map((blog) => (
                            <div key={blog._id} className="bg-[#000435] rounded-lg shadow-lg p-6 w-full md:w-1/2 lg:w-1/3" data-aos="fade-up">
                                ...
                                <a href={`/posts/${blog._id}`} className=" bg-white bg-opacity-40 backdrop-blur-md btn btn-ghost text-yellow-400 px-4 rounded-lg  transition-all transform">Read More</a>
                            </div>
                        ))
                    ) : (
